...
class Colors:
    ...
    def __init__(self):
        ...
        hex = ('32CD32', 'FF0000', 'FF701F', 'FFB21D', 'CFD231', '48F90A', '92CC17', '3DDB86', '1A9334', '00D4BB',
...
class Annotator:
    ...
    def box_label(self, box, label='', color=(255, 0, 0), txt_color=(255, 255, 255)):
        ...
        if self.pil or not is_ascii(label):
            ...
            if label:
                ...
                p2 = p1[0] + w-50, p1[1] - h - 3 if outside else p1[1] + h + 3
                cv2.rectangle(self.im, p1, p2, color, -1, cv2.LINE_AA)  # filled
                cv2.putText(self.im,
                            label, (p1[0], p1[1] - 1 if outside else p1[1] + h + 2),
                            0,
                            self.lw / 4,
                            txt_color,
                            thickness=2,
